...
PY
  ...
  help|--help|-h)
    echo 'Usage: paper_TPAMI/run.sh setup|theory|toy|fixed-policy-toy|vowels-reference|reference-plot|statistics|plot|group-statistics|group-plot|external|native-pilot|sota|phm|ablation|all-cpu'
